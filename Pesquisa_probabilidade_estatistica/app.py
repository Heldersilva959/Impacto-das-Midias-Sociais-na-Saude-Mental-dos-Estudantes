...
@st.cache_data
def load_data():
    file_path = "Impacto_Redes_Sociais_e_Saude_Mental_Estudantes.csv"
    if not os.path.exists(file_path):
        file_path = "Student Social Media And Mental Health Impact_pt_BR.csv"
    if not os.path.exists(file_path):
        file_path = "Student Social Media And Mental Health Impact.csv"
